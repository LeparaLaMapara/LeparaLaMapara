...
**[Ubunye Engine](https://github.com/ubunye-ai-ecosystems/ubunye_engine)** — config-driven,
Spark-native framework for data and ML pipelines. Describe a pipeline once as a folder of
config plus Python, then run that exact folder on a laptop, Docker, Kubernetes, a cloud
cluster or Databricks. Proven to produce identical output hashes across seven environments.
...
I write about MLOps, Spark and Databricks engineering, agentic AI and building systems in
South Africa, including a six-part series on building Ubunye Engine from nothing.
